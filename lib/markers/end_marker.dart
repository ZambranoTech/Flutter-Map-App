...
class EndMarker extends CustomPainter {
  ...
  EndMarker({super.repaint, required this.kilometers, required this.destination});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Caja Negra
    const blackBlox = Rect.fromLTWH(10, 20, 70, 80);

    canvas.drawRect(blackBlox, blackPaint);
